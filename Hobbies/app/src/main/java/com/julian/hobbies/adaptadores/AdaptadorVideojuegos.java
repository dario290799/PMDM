...
public class AdaptadorVideojuegos extends RecyclerView.Adapter<AdaptadorVideojuegos.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(context).inflate(R.layout.fila_recycler_videojuegos,
                parent, false);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            texto=itemView.findViewById(R.id.texto_fila_recycler_videojuegos);
            imagen=itemView.findViewById(R.id.img_fila_recycler_videojuegos);
        }
    ...
    public AdaptadorVideojuegos( Context context,ArrayList<Hobbies> listaHobbies) {
