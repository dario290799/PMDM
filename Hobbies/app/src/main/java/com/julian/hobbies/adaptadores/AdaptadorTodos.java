...
public class AdaptadorTodos extends RecyclerView.Adapter<AdaptadorTodos.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(context).inflate(R.layout.fila_recycler_todos,
                parent, false);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            texto=itemView.findViewById(R.id.texto_fila_recycler_todos);
            imagen=itemView.findViewById(R.id.img_fila_recycler_todos);
        }
    ...
    public AdaptadorTodos( Context context,ArrayList<Hobbies> listaHobbies) {
