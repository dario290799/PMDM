...
public class AdaptadorFutbol extends RecyclerView.Adapter<AdaptadorFutbol.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(context).inflate(R.layout.fila_recycler_futbol,
                parent, false);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            texto=itemView.findViewById(R.id.texto_fila_recycler_Futbol);
            imagen=itemView.findViewById(R.id.img_fila_recycler_futbol);
        }
    ...
    public AdaptadorFutbol( Context context,ArrayList<Hobbies> listaHobbies) {
