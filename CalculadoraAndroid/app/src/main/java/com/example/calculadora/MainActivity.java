...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.borrar:
                ...
                numeroUno = "";
                numeroDos = "";
                operacion.setNumeroUno(0);
                operacion.setNumeroDos(0);
    ...
    private void hacerCalculo() {
        ...
        double resultado = 0;
        operacion.setNumeroUno(Integer.parseInt(numeroUno));
        if (numeroDos.length() > 0) {
            operacion.setNumeroDos(Integer.parseInt(numeroDos));
        }
        switch (operacion.getOperacion()) {
            case "+":
                resultado = (operacion.getNumeroUno() + operacion.getNumeroDos());
            ...
            case "X2":
                ...
                break;
            case "X3":
                resultado = Math.pow(operacion.getNumeroUno(), 3);
                textResultado.setText(String.valueOf(resultado));
                break;
            case "sin":
                resultado = Math.sin(operacion.getNumeroUno());
                textResultado.setText(String.valueOf(resultado));
                break;
            case "cos":
                resultado = Math.cos(operacion.getNumeroUno());
                textResultado.setText(String.valueOf(resultado));
                break;
            case "log":
                resultado = Math.log10(operacion.getNumeroUno());
                textResultado.setText(String.valueOf(resultado));
                break;
            case "sqrt":
                resultado = Math.sqrt(operacion.getNumeroUno());
                textResultado.setText(String.valueOf(resultado));
                break;
            case "tan":
                resultado = Math.tan(operacion.getNumeroUno());
                textResultado.setText(String.valueOf(resultado));
                break;
        }
